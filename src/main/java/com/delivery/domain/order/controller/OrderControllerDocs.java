...
public interface OrderControllerDocs {
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "400",
                    description = "잘못된 날짜 범위 또는 조회 조건"
            ),
            @ApiResponse(
                    responseCode = "401",
                    description = "인증되지 않은 사용자"
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "400",
                    description = "취소할 수 없는 주문 상태 또는 취소 시간 초과"
            ),
            @ApiResponse(
                    responseCode = "401",
                    description = "인증되지 않은 사용자"
    ...
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "주문 거절 성공"
            ),
            @ApiResponse(
                    responseCode = "400",
                    description = "허용되지 않은 주문 상태 변경"
            ),
            @ApiResponse(
                    responseCode = "401",
                    description = "인증되지 않은 사용자"
    ...
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "주문 최종 완료 성공"
            ),
            @ApiResponse(
                    responseCode = "400",
                    description = "완료할 수 없는 주문 상태"
            ),
            @ApiResponse(
                    responseCode = "401",
                    description = "인증되지 않은 사용자"
