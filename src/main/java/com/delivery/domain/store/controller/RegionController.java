...
public class RegionController {
    ...
    @PostMapping
    public ResponseEntity<RestApiResponse<RegionResponse>> createRegion(
    ...
    public ResponseEntity<RestApiResponse<RegionResponse>> updateRegion(
            @PathVariable UUID regionId, @Valid @RequestBody RegionRequest request) {
    ...
    public ResponseEntity<RestApiResponse<Void>> deleteRegion(
            @PathVariable UUID regionId, @AuthenticationPrincipal CustomUserDetails userDetails) {
