...
public record CartResponse(
        @Schema(description = "장바구니 ID", nullable = true, example = "77777777-7777-7777-7777-777777777777")
        UUID cartId,
        @Schema(description = "사용자 ID", nullable = true, example = "1")
        Long userId,
        @Schema(description = "가게 ID", nullable = true, example = "88888888-8888-8888-8888-888888888888")
        UUID storeId,
        @Schema(description = "장바구니 상태", nullable = true)
