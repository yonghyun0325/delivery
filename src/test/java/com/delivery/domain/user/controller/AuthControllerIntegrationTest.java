...
public class AuthControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    class logout {
        ...
        void logout_fail_when_not_found_access_token() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/auth/logout")
                    ...
                    .andExpect(jsonPath("$.message").value(AuthErrorCode.TOKEN_NOT_FOUND.getMessage()));
        }
    }
    ...
    class refresh {
        @Test
        @DisplayName("재발급 성공 시 기존의 Refresh Token을 삭제하고 Body로 Access Token, Cookie로 Refresh Token을 반환한다.")
        ...
        void refresh_fail_when_invalid() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/auth/refresh")
                    ...
                    .andExpect(jsonPath("$.success").value(false))
                    .andExpect(jsonPath("$.data").isEmpty())
                    .andExpect(jsonPath("$.error").value(AuthErrorCode.INVALID_REFRESH_TOKEN.name()))
