...
class ReviewReplyServiceTest {
    ...
    void createReply_success() {
        ...
        when(store.getUserId())
                .thenReturn(ownerId);

        // 기존 답글이 존재하지 않음
        when(reviewReplyRepository.existsByReviewIdAndDeletedAtIsNull(reviewId))
                .thenReturn(false);
        ...
        verify(reviewReplyRepository)
                .existsByReviewIdAndDeletedAtIsNull(reviewId);
    ...
    void createReply_alreadyExists() {
        ...
        assertThatThrownBy(
                ...
                .hasMessage(
                        ReviewReplyErrorCode.REVIEW_REPLY_ALREADY_EXISTS.getMessage());
        ...
        verify(reviewReplyRepository, never())
                .save(any(ReviewReply.class));
    }
    ...
    void createReply_storeOwnerMismatch() {
        ...
        assertThatThrownBy(
                ...
                .isInstanceOf(ReviewReplyException.class)
                .hasMessage(
                        ReviewReplyErrorCode.REVIEW_REPLY_ACCESS_DENIED.getMessage());
