...
class AuthControllerUnitTest {
    ...
    class login {
        ...
        void login_success() throws Exception {
            // given
            LoginRequestDto request = new LoginRequestDto("test1234", "Testtext123!");
        ...
        void login_fail_when_invalid() throws Exception {
            // given
            LoginRequestDto request = new LoginRequestDto("", "Testtext123!");
            LoginRequestDto request2 = new LoginRequestDto("test1234", "");
